	...
	return (
		<>
			{planesData.current.map((plane, i) => {
				...
				// Calculate scale to maintain aspect ratio. three types
				// texture.image as {} so we narrow it before reading dims.
...
export default function InfiniteGallery({
	...
	style,
	// Forwarded to GalleryScene (the original wrapper dropped these, so
	// speed/visibleCount had no effect). zSpacing/falloff are accepted for
	// API completeness but the scene derives depth from DEFAULT_DEPTH_RANGE.
	speed,
	zSpacing,
	visibleCount,
	falloff,
